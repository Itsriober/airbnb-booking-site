<?php
    ...
    if (isset($singelWidgetData->widget_content)) {
        ...
        $limit = $widgetContent['limit'] ? $widgetContent['limit'] : 6;
    ...
    $tour_features = tour_featured($limit, $orderBy);
?>
<?php if($tour_features->count() > 0): ?>
<div class="package-card-section pt-120 mb-120">
    ...
    <img src="<?php echo e(asset('frontend/img/home1/section-vector3.png')); ?>" alt="" class="section-vector3">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
         ...
         <div class="row g-lg-4 gy-5 mb-70">
            <?php $__currentLoopData = $tour_features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         ...
         <div class="row">
            <div class="col-lg-12 d-flex justify-content-center">
                <a href="<?php echo e($btn_link); ?>" class="secondary-btn1"><?php echo e($btn_text); ?></a>
            </div>
         </div>
         <?php endif; ?>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/wpgxubae/public_html/test.harmostays.com/resources/views/frontend/template-1/featured-tour.blade.php ENDPATH**/ ?>