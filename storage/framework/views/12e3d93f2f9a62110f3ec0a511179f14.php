<?php
    ...
    if (isset($singelWidgetData->widget_content)) {
        ...
        $mainTitle = $widgetContent['title'] ? $widgetContent['title'] : '';
        $shoulder = $widgetContent['shoulder'] ? $widgetContent['shoulder'] : '';
        $offers = $widgetContent['offers'] ? $widgetContent['offers'] : 2;
    }
?>

<?php if($offers): ?>
<div class="banner2-section mb-100 mt-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center mb-60">
                        ...
                        <h2><?php echo e($mainTitle); ?></h2>
                    </div>
                </div>
             </div>
             <div class="row g-lg-4 gy-5">
             <?php if(count($offers) <= 3): ?>
             <?php $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $itemData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="<?php if(count($offers) == 3): ?> col-lg-4 <?php elseif(count($offers) == 2): ?> col-lg-6 <?php elseif(count($offers) == 1): ?> col-lg-12 <?php endif; ?>">
                    <div class="banner2-card">
                        <img src="<?php echo e(asset('uploads/offers/'.$itemData['img'])); ?>" alt="<?php echo e($itemData['offer_title']); ?>" width="100%">
                        <div class="banner2-content-wrap">
                            <div class="banner2-content">
                                <span><?php echo e($itemData['offer_title']); ?></span>
                                <h3><?php echo e($itemData['offer_discount']); ?></h3>
                                <a href="<?php echo e($itemData['offer_link']); ?>"><?php echo e($itemData['offer_button']); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php else: ?>
                <div class="col-lg-3">
                    <div class="banner2-card">
                    <img src="<?php echo e(asset('uploads/offers/'.$offers[1]['img'])); ?>" alt="<?php echo e($offers[1]['offer_title']); ?>" width="100%">
                        <div class="banner2-content-wrap">
                            <div class="banner2-content">
                            <span><?php echo e($offers[1]['offer_title']); ?></span>
                                <h3><?php echo e($offers[1]['offer_discount']); ?></h3>
                                <a href="<?php echo e($offers[1]['offer_link']); ?>"><?php echo e($offers[1]['offer_button']); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="banner2-card two mb-30">
                            <img src="<?php echo e(asset('uploads/offers/'.$offers[2]['img'])); ?>" alt="<?php echo e($offers[2]['offer_title']); ?>" width="100%">
                                <div class="banner2-content-wrap">
                                    <div class="banner2-content">
                                    <span><?php echo e($offers[2]['offer_title']); ?></span>
                                    <a href="<?php echo e($offers[2]['offer_link']); ?>"><?php echo e($offers[2]['offer_button']); ?></a>
                                    </div>
                                    <div class="offer-batch">
                                    <span><?php echo e($offers[2]['offer_discount']); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            ...
                            <img src="<?php echo e(asset('uploads/offers/'.$offers[3]['img'])); ?>" alt="<?php echo e($offers[3]['offer_title']); ?>" width="100%">
                                <div class="banner2-content-wrap d-flex align-items-center">
                                    <div class="w-100">
                                        <div class="banner2-content">
                                        <span><?php echo e($offers[3]['offer_title']); ?></span>
                                <h5><?php echo e($offers[3]['offer_discount']); ?></h5>
                                <p><?php echo e(translate('For Your First Book')); ?></p>
                                        </div>
                                        <a href="<?php echo e($offers[3]['offer_link']); ?>" class="primary-btn1"><?php echo e($offers[3]['offer_button']); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <img src="<?php echo e(asset('uploads/offers/'.$offers[4]['img'])); ?>" alt="<?php echo e($offers[4]['offer_title']); ?>" width="100%">
                        <div class="banner2-content-wrap">
                            <div class="banner2-content">
                            <span><?php echo e($offers[4]['offer_title']); ?></span>
                            <h3><?php echo e($offers[4]['offer_discount']); ?></h3>
                            <p><?php echo e(translate('For Your First Book')); ?></p>
                            </div>
                            <a href="<?php echo e($offers[4]['offer_link']); ?>" class="primary-btn1"><?php echo e($offers[4]['offer_button']); ?></a>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/wpgxubae/public_html/test.harmostays.com/resources/views/frontend/template-1/offers.blade.php ENDPATH**/ ?>