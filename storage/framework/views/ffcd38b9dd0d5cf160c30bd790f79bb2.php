                        ...
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
                                ...
                                <input type="number" class="username-input"
                                    placeholder="<?php echo e(translate('Enter Number of Display')); ?>"
                                    name="content[0][display]"
                                    value="<?php echo e(isset($widgetContents['display']) ? $widgetContents['display'] : 6); ?>">
                            </div>
                        </div>
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
                                ...
                                <input type="text" class="username-input"
                                    placeholder="<?php echo e(translate('Enter Number of Display')); ?>"
                                    name="content[0][display]" value="6">
                            </div>
                        </div>
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
...
<?php endif; ?>
<?php /**PATH /mnt/c/Users/jstnh/airbnb-booking-site/resources/views/backend/pages/widgets/visa-processing.blade.php ENDPATH**/ ?>