<h4><?php echo e(translate('Book Your Room')); ?></h4>
<p><?php echo e(translate('Reserve your ideal Room early for a hassle-free trip; secure comfort and convenience!')); ?></p>
        ...
        <div class="sidebar-booking-form">
            <form action="<?php echo e(route('checkout')); ?>" method="POST" class="purchase-form">
                ...
                <div class="tour-date-wrap mb-50">
                    ...
                    <?php if($hotels->check_in && $hotels->check_out): ?>
                            ...
                            <label class="form-check-label" for="checkIn">
                                <span class="tour-date">
                                    <span class="start-date">
                                        ...
                                        <span><?php echo e(date('h:i:sa', strtotime($hotels->check_in))); ?></span>
                                    </span>
                                    <i class="bi bi-arrow-right"></i>
                                    <span class="end-date text-end">
                                        <span><?php echo e(translate('Check Out')); ?></span>
                                        <span><?php echo e(date('h:i:sa', strtotime($hotels->check_out))); ?></span>
                                    </span>
                                </span>
                            </label>
                        </div>
                ...
                <div class="booking-form-item-type mb-45">
                    <div class="number-input-item adults">
                        <label class="number-input-lable"><?php echo e(translate('Room Quantity')); ?>:<span>
                            </span><span class="hotelPrice"><?php echo e(currency_symbol() . $hotels->price); ?></span></label>
                    ...
                    <input type="hidden" class="mainPrice" name="price"
                                value="<?php echo e($hotels->price ?? 0); ?>">
                            ...
                            <input type="hidden" class="unitPrice" name="adult_unit_price" value="<?php echo e($hotels->price ?? 0); ?>">
                            <input type="hidden" name="aqty" class="aqty" value="1">
                </div>
                <!-- Children Section -->
                <div class="number-input-item children">
                    <label class="number-input-lable"><?php echo e(translate('Maximum Guests')); ?>:</label>
                    <div class="quantity-counter">
                        ...
                        <input name="quantity" type="text" class="quantity__input"
                            value="<?php echo e($hotels->guest_capability > 9 ? $hotels->guest_capability : '0' . $hotels->guest_capability); ?>">

                        <a href="#" class="quantity__plus_hotel guest-quantity__plus" data-type="guest"><i
                                class="bi bi-plus"></i></a>
                    </div>

                    <input type="hidden" class="guest_qty" name="guest_capability" value="<?php echo e($hotels->guest_capability ?? 0); ?>">
                    <input type="hidden" name="cqty" class="guest_capability"
                        value="<?php echo e($hotels->guest_capability ?? 0); ?>">
                            ...
                            <?php if(isset($service->price)): ?>
                                <label class="check-container"><?php echo e($service->name); ?>
                                    ...
                                    <input type="checkbox" class="services_check extra_services_check"
                                        name="services_list[]" value="<?php echo e($key); ?>"
                                        data-type="<?php echo e($service->price_type); ?>" data-unit="<?php echo e($service->unit); ?>"
                ...
                <div class="single-total mb-30">
                    <span><?php echo e(translate('Room')); ?></span>
                    <ul>
                        <li><strong class="hotel_p"><?php echo e(currency_symbol() . $hotels->price); ?></strong>
                            <?php echo e(translate('PRICE')); ?></li>
                        <li><i class="bi bi-x-lg"></i></li>
                        <li><strong class="room_qty">01</strong> <?php echo e(translate('QTY')); ?></li>
                        <li><i class="bi bi-x-lg"></i></li>
                        <li><strong class="days_show">01</strong> <?php echo e(translate('DAYS')); ?></li>
                    </ul>
                    <div class="total_p"><?php echo e(currency_symbol()); ?><span
                            class="atotal"><?php echo e($hotels->price ?? 0); ?></span></div>
                </div>

                <div class="total-price"><span><?php echo e(translate('Total Amount')); ?>:</span><span> <?php echo e(currency_symbol()); ?><span
                        class="total_amount_show"><?php echo e($hotels->price ?? 0); ?></span></span></div>
                <input type="hidden" name="total_amount" class="total_amount" value="<?php echo e($hotels->price ?? 0); ?>">
...
<?php $__env->startPush('js'); ?>
    <script src="<?php echo e(asset('frontend/js/hotel.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php /**PATH /home/wpgxubae/public_html/test.harmostays.com/resources/views/frontend/template-1/includes/hotel/booking.blade.php ENDPATH**/ ?>