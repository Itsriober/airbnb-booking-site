<?php
    $testimonial_shoulder = '';
    $testimonial_title = '';
    $testimonials = [];

    if ($singelWidgetData->widget_content) {
        $widgetContent = $singelWidgetData->getTranslation('widget_content');
        $testimonial_shoulder = isset($widgetContent['testimonial_shoulder']) ? $widgetContent['testimonial_shoulder'] : '';
        $testimonial_title = isset($widgetContent['testimonial_title']) ? $widgetContent['testimonial_title'] : '';
        $testimonials = isset($widgetContent['testimonials']) ? $widgetContent['testimonials'] : '';
    }
?>
<?php if($testimonials): ?>
            ...
            <div class="col-lg-12">
                <div class="section-title text-center mb-60">
                    <span>
                        ...
                        <?php echo e($testimonial_shoulder); ?>
        ...
        <div class="container">
            <div class="testimonial-nav-area">
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    <?php if(isset($testimonials['tripadvisor'])): ?>
                    <li class="nav-item" role="presentation">
                      <div class="nav-link <?php echo e(isset($testimonials['tripadvisor']) ? 'active' : ''); ?>" id="tripadvisor-tab" data-bs-toggle="pill" data-bs-target="#tripadvisor" role="tab" aria-controls="tripadvisor" aria-selected="true">
                        <div class="icon">
                            <img src="<?php echo e(asset('frontend/img/home1/icon/tripadvisor-logo3.svg')); ?>" alt="">
                        </div>
                        <?php echo e(translate('Tripadvisor')); ?>

                    </div>
                    </li>
                    <?php endif; ?>
                    <?php if(isset($testimonials['facebook'])): ?>
                    <li class="nav-item" role="presentation">
                      <div class="nav-link <?php echo e(!isset($testimonials['tripadvisor']) && isset($testimonials['facebook']) ? 'active' : ''); ?>" id="facebook-tab" data-bs-toggle="pill" data-bs-target="#facebook" role="tab" aria-controls="facebook" aria-selected="false">
                        <div class="icon">
                            <img src="<?php echo e(asset('frontend/img/home1/icon/facebook-logo.svg')); ?>" alt="">
                        </div>
                    ...
                    <?php endif; ?>
                    <?php if(isset($testimonials['google'])): ?>
                    <li class="nav-item" role="presentation">
                      <div class="nav-link <?php echo e(!isset($testimonials['tripadvisor']) && !isset($testimonials['facebook']) && isset($testimonials['google']) ? 'active' : ''); ?>" id="google-tab" data-bs-toggle="pill" data-bs-target="#google" role="tab" aria-controls="google" aria-selected="false">
                        <div class="icon">
                            <img src="<?php echo e(asset('frontend/img/home1/icon/google-logo.svg')); ?>" alt="">
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tab-content" id="pills-tabContent">
                            <?php if(isset($testimonials['tripadvisor'])): ?>
                            <div class="tab-pane fade <?php echo e(isset($testimonials['tripadvisor']) ? 'show active' : ''); ?>" id="tripadvisor" role="tabpanel" aria-labelledby="tripadvisor-tab">
                                <div class="swiper testimonial-card-slider">
                                    <div class="swiper-wrapper">
                                        <?php $__currentLoopData = $testimonials['tripadvisor']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="tesimonial-card-wrapper">
                                                <div class="tesimonial-card">
                                                    ...
                                                    <div class="testimonial-bottom">
                                                        <div class="rating-area tripadvisor">
                                                            ...
                                                            <img class="d-block" src="<?php echo e(asset('frontend/img/home1/icon/tripadvisor-text-logo.svg')); ?>" alt="">
                                                        </div>
                                                        <div class="quote">
                                                        ...
                                                        <div class="date-and-time">
                                                            <p><?php echo e(date('M d, Y', strtotime($item['time']))); ?></p>
                                                            <span><?php echo e(date('H:i A', strtotime($item['time']))); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="author-area">
                                                    ...
                                                    <div class="author-img">
                                                        <img src="<?php echo e(('uploads/testimonials/'.$item['img'])); ?>" alt="<?php echo e($item['name']); ?>">
                                                    </div>
                                                    <?php endif; ?>
                                                    <div class="author-content">
                                                        <h5><?php echo e($item['name']); ?></h5>
                                                        <span><?php echo e($item['country']); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <?php endif; ?>
                            <?php if(isset($testimonials['facebook'])): ?>
                            <div class="tab-pane fade <?php echo e(!isset($testimonials['tripadvisor']) && isset($testimonials['facebook']) ? 'show active' : ''); ?>" id="facebook" role="tabpanel" aria-labelledby="facebook-tab">
                                <div class="swiper testimonial-card-slider">
                                    <div class="swiper-wrapper">
                                        <?php $__currentLoopData = $testimonials['facebook']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="swiper-slide">
                                            <div class="tesimonial-card-wrapper">
                                                <div class="tesimonial-card">
                                                    <div class="testimonial-content">
                                                    ...
                                                    <div class="testimonial-bottom">
                                                        <div class="rating-area">
                                                            ...
                                                            <img src="<?php echo e(asset('frontend/img/home1/icon/facebook-text-logo.svg')); ?>" alt="">
                                                        </div>
                                                        <div class="quote">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="74" height="51" viewBox="0 0 74 51">
                                                                <g>
                            ...
                            <?php endif; ?>
                            <?php if(isset($testimonials['google'])): ?>
                            <div class="tab-pane fade <?php echo e(!isset($testimonials['tripadvisor']) && !isset($testimonials['facebook']) && isset($testimonials['google']) ? 'show active' : ''); ?>" id="google" role="tabpanel" aria-labelledby="google-tab">
                                <div class="swiper testimonial-card-slider">
                                    <div class="swiper-wrapper">
                                        <?php $__currentLoopData = $testimonials['google']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="swiper-slide">
                                            <div class="tesimonial-card-wrapper">
                                                <div class="tesimonial-card">
                                                    <div class="testimonial-content">
                                                    ...
                                                    <div class="testimonial-bottom">
                                                        <div class="rating-area">
                                                            ...
                                                            <img src="<?php echo e(asset('frontend/img/home1/icon/google-text-logo.svg')); ?>" alt="">
                                                        </div>
                                                        <div class="quote">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="74" height="51" viewBox="0 0 74 51">
                                                                <g>
...
<?php endif; ?><?php /**PATH /home/wpgxubae/public_html/test.harmostays.com/resources/views/frontend/template-1/testimonial.blade.php ENDPATH**/ ?>