<?php
    ...
    if (isset($singelWidgetData->widget_content)) {
        ...
        $mainShoulder = $widgetContent['shoulder'] ? $widgetContent['shoulder'] : '';
        $offerTitle = $widgetContent['offer_title'] ? $widgetContent['offer_title'] : '';
        $offerText = $widgetContent['offer_text'] ? $widgetContent['offer_text'] : '';
        $btn_text = $widgetContent['btn_text'] ? $widgetContent['btn_text'] : '';
        $btn_link = $widgetContent['btn_link'] ? $widgetContent['btn_link'] : '';
        $orderBy = $widgetContent['order_by'] ? $widgetContent['order_by'] : 'desc';
    }

    $destinations = destinations($limit, '', $orderBy);
?>
<?php if($destinations): ?>
<div class="home1-destination-section mb-120">
    <img src="<?php echo e(asset('frontend/img/home1/section-vector2.png')); ?>" alt="destinations" class="section-vector2">
    <div class="container">
         <div class="row">
            <div class="col-lg-12">
         ...
         <div class="row g-4">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="destination-card">
                   <img src="<?php echo e(asset('uploads/destination/features/'.$destination->features_image)); ?>" alt="<?php echo e($destination->title); ?>">
                   <div class="overlay"></div>
                   <div class="card-title">
                        <h4><?php echo e($destination->getTranslation('destination')); ?></h4>
                   </div>
                   <div class="content">
                        <h4><a href="<?php echo e(route('destination.details',$destination->slug)); ?>"><?php echo e($destination->getTranslation('destination')); ?></a></h4>
                        <div class="eg-tag">
                            <span>
                                <?php echo e($destination->tours?->count()); ?> <?php echo e(translate('Tour')); ?>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="destination-banner">
                    <div class="destination-banner-content">
                        <div class="batch">
                            <span>
                                <?php echo e($offerText); ?>

                            </span>
                        </div>
                        <h2><?php echo e($offerTitle); ?></h2>
                        <?php if($btn_text && $btn_link): ?>
                        <a href="<?php echo e($btn_link); ?>" class="primary-btn1"><?php echo e($btn_text); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH /home/wpgxubae/public_html/test.harmostays.com/resources/views/frontend/template-1/latest-destination.blade.php ENDPATH**/ ?>