<?php $__env->startSection('content'); ?>
    <div class="page-title2">
        ...
        <h5><?php echo e(translate('Backend Settings')); ?></h5>
        <a class="clear-cache" title="Remove all old data or demo data to default state." onclick="return confirm('Are you sure remove old all data to default state?')" href="<?php echo e(route('deleteDemoData')); ?>"><i class="bi bi-eraser"></i> Clear All Data</a>
    </div>
    <form action="<?php echo e(route('backend.settings.store')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="tab-area settings-area">
            <div class="nav flex-row jusify-content-start nav-pills" id="v-pills-tab" role="tablist"
                ...
                <button class="nav-link" id="v-pills-setting-tab" data-bs-toggle="pill" data-bs-target="#v-pills-setting"
                    ...
                    aria-selected="true"><?php echo e(translate('Email Configuration')); ?></button>
                ...
                <button class="nav-link" id="v-pills-recaptcha-tab" data-bs-toggle="pill"
                    ...
                    aria-selected="true"><?php echo e(translate('Google reCAPTCHA')); ?></button>
                ...
                <button class="nav-link" id="v-pills-tawk-tab" data-bs-toggle="pill" data-bs-target="#v-pills-tawk"
                    ...
                    aria-selected="true"><?php echo e(translate('Tawk Chat')); ?></button>
                <button class="nav-link" id="v-pills-system-info-tab" data-bs-toggle="pill"
                    ...
                    aria-selected="true"><?php echo e(translate('System Information')); ?></button>
            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    <label><?php echo e(translate('Application Name')); ?></label>
                                    <input type="text" class="form-control"
                                        value="<?php echo e(old('company_name', get_setting('company_name'))); ?>" name="company_name"
                                        placeholder="<?php echo e(translate('Application Name')); ?>">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    <label><?php echo e(translate('Currency')); ?></label>
                                    <select class="js-example-basic-single" name="default_currency">
                                        ...
                                        <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($currency->id); ?>"
                                                <?php echo e(old('default_currency', get_setting('default_currency')) == $currency->id ? 'selected' : ''); ?>>
                                                <?php echo e($currency->name . ' - ' . $currency->symbol); ?></option>
                            ...
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    <label><?php echo e(translate('VAT/Tax Rate for Customer')); ?></label>
                                    <input type="text" name="tax_rate"
                                        value="<?php echo e(old('tax_rate', get_setting('tax_rate'))); ?>"
                                        placeholder="<?php echo e(translate('TAX Rate')); ?>" aria-label="TAX Rate"
                            ...
                            <div class="col-xl-6">
                                <div class="form-inner mb-35 position-relative">
                                    <label><?php echo e(translate('System Timezone')); ?></label>
                            ...
                            <div class="col-xl-6">
                                <div class="form-inner mb-35 position-relative">
                                    <label><?php echo e(translate('Date Format')); ?></label>
                                    <select class="form-control custom-select" name="date_format" id="date_format"
                                        required="required">
                                        <option value="M j, Y"
                                            <?php echo e(old('date_format', get_setting('date_format')) == 'M j, Y' ? 'selected' : ''); ?>>
                                            Oct 30, 2023</option>
                                        <option value="Y-m-d"
                                            <?php echo e(old('date_format', get_setting('date_format')) == 'Y-m-d' ? 'selected' : ''); ?>>
                                            2023-10-30</option>
                                        <option value="d-m-Y"
                                            <?php echo e(old('date_format', get_setting('date_format')) == 'd-m-Y' ? 'selected' : ''); ?>>
                                            30-10-2023</option>
                                        <option value="d/m/Y"
                                            <?php echo e(old('date_format', get_setting('date_format')) == 'd/m/Y' ? 'selected' : ''); ?>>
                                            30/10/2023 </option>
                                        <option value="m/d/Y"
                                            <?php echo e(old('date_format', get_setting('date_format')) == 'm/d/Y' ? 'selected' : ''); ?>>
                                            10/30/2023 </option>
                                        <option value="m.d.Y"
                                            <?php echo e(old('date_format', get_setting('date_format')) == 'm.d.Y' ? 'selected' : ''); ?>>
                                            10.30.2023 </option>
                                        <option value="j, n, Y"
                                            <?php echo e(old('date_format', get_setting('date_format')) == 'j, n, Y' ? 'selected' : ''); ?>>
                                            30, 10, 2023 </option>
                                        <option value="F j, Y"
                                            <?php echo e(old('date_format', get_setting('date_format')) == 'F j, Y' ? 'selected' : ''); ?>>
                                            October 30, 2023 </option>
                                        <option value="M j, Y"
                                            <?php echo e(old('date_format', get_setting('date_format')) == 'M j, Y' ? 'selected' : ''); ?>>
                                            Oct 30, 2023</option>
                                        <option value="j M, Y"
                                            <?php echo e(old('date_format', get_setting('date_format')) == 'j M, Y' ? 'selected' : ''); ?>>
                                            30 Oct, 2023</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    <label><?php echo e(translate('Commission from Merchant')); ?></label>
                                    <input type="text" name="merchant_commission"
                                        value="<?php echo e(old('merchant_commission', get_setting('merchant_commission'))); ?>"
                                        placeholder="<?php echo e(translate('Commission from Merchant')); ?>"
                            ...
                            <div class="col-xl-6">
                                <div class="payment-method-header">
                                    <label><?php echo e(translate('Email Verification (Merchant)')); ?></label>
                                    <div class="pmt-active-inactive">
                                        <button
                                            class="eg-btn  <?php echo e(get_setting('merchant_email_verification') == 1 ? 'green-light--btn ' : 'red-light--btn '); ?>">
                                            <?php echo e(get_setting('merchant_email_verification') == 1 ? 'Active' : 'Deactivate'); ?>

                                        </button>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                name="merchant_email_verification"
                                                <?php echo e(old('merchant_email_verification', get_setting('merchant_email_verification')) == 1 ? 'checked' : ''); ?>>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="payment-method-header">
                                    <label><?php echo e(translate('Email Verification (Customer)')); ?></label>
                                    <div class="pmt-active-inactive">
                                        <button
                                            class="eg-btn  <?php echo e(get_setting('customer_email_verification') == 1 ? 'green-light--btn ' : 'red-light--btn '); ?>">
                                            <?php echo e(get_setting('customer_email_verification') == 1 ? 'Active' : 'Deactivate'); ?>

                                        </button>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                name="customer_email_verification"
                                                <?php echo e(old('customer_email_verification', get_setting('customer_email_verification')) == 1 ? 'checked' : ''); ?>>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    <label><?php echo e(translate('Admin Logo')); ?></label>
                                    <input type="file" name="admin_logo" class="form-control">
                                    <?php if(get_setting('admin_logo')): ?>
                                        <img class="mt-2" src="<?php echo e(asset('assets/logo/' . get_setting('admin_logo'))); ?>"
                                            alt="Admin Logo" width="100">
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    <label><?php echo e(translate('Invoice Logo')); ?></label>
                                    <input type="file" name="invoice_logo" class="form-control">
                                    <?php if(get_setting('invoice_logo')): ?>
                                        <img class="mt-2" src="<?php echo e(asset('assets/logo/' . get_setting('invoice_logo'))); ?>"
                            ...
                            <div class="col-xl-12">
                                <button type="button" class="eg-btn btn--primary back-btn float-end"
                                    data-bs-toggle="modal" data-bs-target="#testMail"><img
                                        src="<?php echo e(asset('backend/images/icons/add-icon.svg')); ?>" alt="Test Mail">
                                    <?php echo e(translate('Test Mail')); ?></button>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    ...
                                    <select class="js-example-basic-single" name="mail_driver">
                                        <option value=""><?php echo e(translate('Select Option')); ?></option>
                                        <option value="smtp"
                                            <?php echo e(old('mail_driver', get_setting('mail_driver')) == 'smtp' ? 'selected' : ''); ?>>
                                            smtp</option>
                                        <option value="sendmail"
                                            <?php echo e(old('mail_driver', get_setting('mail_driver')) == 'sendmail' ? 'selected' : ''); ?>>
                                            sendmail</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    ...
                                    <input type="text" class="form-control"
                                        value="<?php echo e(old('mail_host', get_setting('mail_host'))); ?>" name="mail_host"
                            ...
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    ...
                                    <input type="text" class="form-control"
                                        value="<?php echo e(old('mail_port', get_setting('mail_port'))); ?>" name="mail_port"
                                        placeholder="<?php echo e(translate('Port')); ?>">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    <label><?php echo e(translate('From Address')); ?></label>
                                    <input type="text" class="form-control"
                                        value="<?php echo e(old('mail_from_address', get_setting('mail_from_address'))); ?>"
                                        name="mail_from_address" placeholder="<?php echo e(translate('From Address')); ?>">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    <label><?php echo e(translate('From Name')); ?></label>
                                    <input type="text" class="form-control"
                                        value="<?php echo e(old('mail_from_name', get_setting('mail_from_name'))); ?>"
                                        name="mail_from_name" placeholder="<?php echo e(translate('From Name')); ?>">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    ...
                                    <input type="text" class="form-control"
                                        value="<?php echo e(old('mail_encryption', get_setting('mail_encryption'))); ?>"
                                        name="mail_encryption" placeholder="<?php echo e(translate('Encryption')); ?>">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control"
                                        value="<?php echo e(old('mail_username', get_setting('mail_username'))); ?>"
                                        name="mail_username" placeholder="<?php echo e(translate('Username')); ?>">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control"
                                        value="<?php echo e(old('mail_password', get_setting('mail_password'))); ?>"
                                        name="mail_password" placeholder="<?php echo e(translate('Password')); ?>">
                                </div>
                            </div>
                    ...
                    <div class="eg-card product-card">
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-check form-switch col-sm-10">
                                        <input class="form-check-input" value="1" name="google_recapcha_check"
                                            <?php echo e(get_setting('google_recapcha_check') == 1 ? 'checked' : ''); ?>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="form-inner mb-35">
                                        <label><?php echo e(translate('Recaptcha Key')); ?></label>
                                        <input type="text" class="form-control"
                                            value="<?php echo e(old('recaptcha_key', get_setting('recaptcha_key'))); ?>"
                                            name="recaptcha_key" placeholder="<?php echo e(translate('Recaptcha Key')); ?>">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="form-inner mb-35">
                                        <label><?php echo e(translate('Recaptcha Secret')); ?></label>
                                        <input type="text" class="form-control"
                                            value="<?php echo e(old('recaptcha_secret', get_setting('recaptcha_secret'))); ?>"
                                            name="recaptcha_secret" placeholder="<?php echo e(translate('Recaptcha Secret')); ?>">
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade" id="v-pills-tawk" role="tabpanel" aria-labelledby="v-pills-tawk-tab">
                    <div class="eg-card product-card">
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-check form-switch col-sm-10">
                                        <input class="form-check-input" value="1" name="tawk_enabled"
                                            <?php echo e(get_setting('tawk_enabled') == 1 ? 'checked' : ''); ?> type="checkbox"
                            ...
                            <div class="col-xl-12">
                                <label class="col-sm-2 mb-2"><b><?php echo e(translate('Tawk Embed Url')); ?></b></label>
                                <div class="form-inner mb-35">
                                    <input type="text" value="<?php echo e(get_setting('tawk_code')); ?>" name="tawk_code">
                                </div>
                                <p> <a href="https://www.tawk.to/" target="_blank"> <b>
                                            <?php echo e(translate('Go to Tawk')); ?></b> </a></p>
                    ...
                    <div class="eg-card product-card">
                        <div class="system-information">
                            <table class="eg-table">
                                <tbody>
                                    <tr>
                                        <td><strong><?php echo e(translate('PHP Version')); ?></strong></td>
                                        <td> <?php echo e(phpversion()); ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong><?php echo e(translate('Laravel Version')); ?></strong></td>
                                        <td><?php echo e(app()->version()); ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong><?php echo e(translate('Server Software')); ?></strong></td>
                                        <td>LiteSpeed</td>
                                    </tr>
                                    <tr>

                                        <td><strong><?php echo e(translate('Server IP Address')); ?></strong></td>
                                        <td><?php echo e($_SERVER['REMOTE_ADDR']); ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong><?php echo e(translate('Server Protocol')); ?></strong></td>
                                        <td><?php echo e($_SERVER['SERVER_PROTOCOL']); ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong><?php echo e(translate('HTTP Host')); ?></strong></td>
                                        <td><?php echo e(env('DB_HOST')); ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong><?php echo e(translate('Database Port')); ?></strong></td>
                                        <td><?php echo e(env('DB_PORT')); ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong> <?php echo e(translate('App Environment')); ?> </strong></td>
                                        <td><?php echo e(Config::get('app.env')); ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong><?php echo e(translate('App Debug')); ?></strong></td>
                                        <td><?php echo e(Config::get('app.debug') == 1 ? 'true' : 'false'); ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong><?php echo e(translate('Timezone')); ?></strong></td>
                                        <td><?php echo e(Config::get('app.timezone')); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <input type="hidden" value="<?php echo e(get_setting('time_zone')); ?>" id="timezoneValue">
    <?php echo $__env->make('backend.backend_setting.modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/wpgxubae/public_html/test.harmostays.com/resources/views/backend/backend_setting/index.blade.php ENDPATH**/ ?>