    ...
    <div class="sidebar">
        <div class="sidebar-menu-wrapper pb-110" style="margin-top=5px;">
            <ul class="side-menu-list gap-3">
                <li <?php if(Illuminate\Support\Facades\Route::is('backend.dashboard')): ?> class="active" <?php endif; ?>>
                ...
                <li <?php if(Illuminate\Support\Facades\Route::is('hotels.list') ||
                        request()->is('dashboard/hotels/*') ||
                        Illuminate\Support\Facades\Route::is('hotel.attribute.list') ||
                        request()->is('dashboard/hotel/attribute/*') ||
                        Illuminate\Support\Facades\Route::is('hotel.attribute.term.list')): ?> class="active" <?php endif; ?>>
                    <a href="<?php echo e(route('hotels.list')); ?>">
                        ...
                        <h6><?php echo e(translate('Stays')); ?></h6>
                    </a>
                </li>
                <li <?php if(Illuminate\Support\Facades\Route::is('destination.list')): ?> class="active" <?php endif; ?>>
                    <a href="<?php echo e(route('destination.list')); ?>">
                        ...
                        <h6><?php echo e(translate('Destinations')); ?></h6>
                    </a>
                </li>
                <li <?php if(Illuminate\Support\Facades\Route::is('tours.list') ||
                        request()->is('dashboard/tours/*') ||
                        Illuminate\Support\Facades\Route::is('tour.attribute.list') ||
                        request()->is('dashboard/tour/attribute/*') ||
                        Illuminate\Support\Facades\Route::is('tour.attribute.term.list')): ?> class="active" <?php endif; ?>>
                    <a href="<?php echo e(route('tours.list')); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                        ...
                        <h6><?php echo e(translate('Tours')); ?></h6>
                    </a>
                </li>
                <li <?php if(Illuminate\Support\Facades\Route::is('activities.list') ||
                        ...
                        Illuminate\Support\Facades\Route::is('activities.attribute.term.list')): ?> class="active" <?php endif; ?>>
                    <a href="<?php echo e(route('activities.list')); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                            class="bi bi-activity" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
                                d="M6 2a.5.5 0 0 1 .47.33L10 12.036l1.53-4.208A.5.5 0 0 1 12 7.5h3.5a.5.5 0 0 1 0 1h-3.15l-1.88 5.17a.5.5 0 0 1-.94 0L6 3.964 4.47 8.171A.5.5 0 0 1 4 8.5H.5a.5.5 0 0 1 0-1h3.15l1.88-5.17A.5.5 0 0 1 6 2" />
                        </svg>
                        <h6><?php echo e(translate('Experiences')); ?></h6>
                    </a>
                </li>
                <li <?php if(Illuminate\Support\Facades\Route::is('transports.list') ||
                        ...
                        Illuminate\Support\Facades\Route::is('transports.attribute.term.list')): ?> class="active" <?php endif; ?>>
                    <a href="<?php echo e(route('transports.list')); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                        ...
                        <h6><?php echo e(translate('Rentals')); ?></h6>
                    </a>
                </li>

                <li <?php if(Illuminate\Support\Facades\Route::is('visa.list')): ?> class="active" <?php endif; ?>>
                    <a href="<?php echo e(route('visa.list')); ?>">
                        ...
                        <h6><?php echo e(translate('Visa')); ?></h6>
                    </a>
                </li>
                <li <?php if(Illuminate\Support\Facades\Route::is('backend.order.info')): ?> class="active" <?php endif; ?>>
                    <a href="<?php echo e(route('backend.order.info')); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                            class="bi bi-x-diamond" viewBox="0 0 16 16">
                            <path
                                d="M7.987 16a1.53 1.0 0 0 1-1.07-.448L.45 9.082a1.53 1.53 0 0 1 0-2.165L6.917.45a1.53 1.53 0 0 1 2.166 0l6.469 6.468A1.53 1.53 0 0 1 16 8.013a1.53 1.53 0 0 1-.448 1.07l-6.47 6.469A1.53 1.53 0 0 1 7.988 16zM7.639 1.17 4.766 4.044 8 7.278l3.234-3.234L8.361 1.17a.51.51 0 0 0-.722 0M8.722 8l3.234 3.234 2.873-2.873c.2-.2.2-.523 0-.722l-2.873-2.873zM8 8.722l-3.234 3.234 2.873 2.873c.2.2.523.2.722 0l2.873-2.873zM7.278 8 4.044 4.766 1.17 7.639a.51.51 0 0 0 0 .722l2.874 2.873z" />
                        </svg>
                        <h6><?php echo e(translate('Booking')); ?></h6>
                    </a>
                </li>
                <li <?php if(Illuminate\Support\Facades\Route::is('backend.transaction')): ?> class="active" <?php endif; ?>>
                    <a href="<?php echo e(route('backend.transaction')); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                            class="bi bi-arrow-left-right" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
                                d="M1 11.5a.5.5 0 0 0 .5.5h11.793l-3.147 3.146a.5.5 0 0 0 .708.708l4-4a.5.5 0 0 0 0-.708l-4-4a.5.5 0 0 0-.708.708L13.293 11H1.5a.5.5 0 0 0-.5.5zm14-7a.5.5 0 0 1-.5.5H2.707l3.147 3.146a.5.5 0 1 1-.708.708l-4-4a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 4H14.5a.5.5 0 0 1 .5.5z" />
                        </svg>
                        <h6><?php echo e(translate('Transaction')); ?></h6>
                    </a>
                </li>
                <?php if (\Illuminate\Support\Facades\Blade::check('admin')): ?>
                    <li <?php if(Illuminate\Support\Facades\Route::is('merchant.list') || request()->is('dashboard/merchant/*')): ?> class="active" <?php endif; ?>>
                        <a href="<?php echo e(route('merchant.list')); ?>">
                            ...
                            <h6><?php echo e(translate('Frontend Setting')); ?></h6>
                        </a>
                    </li>
                ...
                <li <?php if(Illuminate\Support\Facades\Route::is('payment.methods')): ?> class="active" <?php endif; ?>>
                    <a href="<?php echo e(route('payment.methods')); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-credit-card" viewBox="0 0 16 16">
                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2-1a1 1 0 0 0-1 1v1h14V4a1 1 0 0 0-1-1H2zm13 3H1v6a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V6zM2 9a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm2 1a1 1 0 1 1 2 0 1 1 0 0 1-2 0z"/>
                        </svg>
                        <h6><?php echo e(translate('Payment Methods')); ?></h6>
                    </a>
                </li>
                <?php if (\Illuminate\Support\Facades\Blade::check('admin')): ?>
                    <li <?php if(Illuminate\Support\Facades\Route::is('users.list')): ?> class="active" <?php endif; ?>>
                        <a href="<?php echo e(route('users.list')); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
                                <path d="M13 7a3 3 0 1 0-6 0 3 3 0 0 0 6 0zM6 7a2 2 0 1 1 4 0 2 2 0 0 1-4 0z"/>
                                <path fill-rule="evenodd" d="M13 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H13zm-7 0s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H6z"/>
                            </svg>
            ...
            <ul class="d-flex align-items-center justify-content-center flex-wrap gap-5 m-0 p-0">
                <li><a href="<?php echo e(route('logout')); ?>"
                        onclick="event.preventDefault();
                            ...
                            src="<?php echo e(asset('backend/images/icons/power.svg')); ?>" alt=""></a></li>
...
<?php /**PATH /mnt/c/Users/jstnh/airbnb-booking-site/resources/views/backend/layouts/sidebar.blade.php ENDPATH**/ ?>