            ...
            <div class="accordion-body">
                ...
                <form enctype="multipart/form-data" data-action="<?php echo e(route('pages.widget.save')); ?>" class="form"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
                                ...
                                <select class="js-example-basic-single" name="content[0][order_by]">
                                    ...
                                    <option value="desc"
                                        <?php echo e(isset($widgetContents['order_by']) && $widgetContents['order_by'] == 'desc' ? 'selected' : ''); ?>>
                                        <?php echo e(translate('Descending')); ?></option>
                                    <option value="asc"
                                        <?php echo e(isset($widgetContents['order_by']) && $widgetContents['order_by'] == 'asc' ? 'selected' : ''); ?>>
                        ...
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
                                <label><?php echo e(translate('Offer Text')); ?></label>
                                <input type="text" class="username-input"
                                    placeholder="<?php echo e(translate('Enter Offer Text')); ?>"
                                    name="content[0][offer_text]" value="<?php echo e(isset($widgetContents['offer_text']) ? $widgetContents['offer_text'] : ''); ?>">
                            </div>
                        </div>
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
                                <label><?php echo e(translate('Offer Title')); ?></label>
                                <input type="text" class="username-input"
                                    placeholder="<?php echo e(translate('Enter Offer Title')); ?>"
                                    name="content[0][offer_title]" value="<?php echo e(isset($widgetContents['offer_title']) ? $widgetContents['offer_title'] : ''); ?>">
                            </div>
                        </div>
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
                        ...
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
                                ...
                                <input type="text" class="username-input"
                                    ...
                                    name="content[0][btn_link]" value="<?php echo e(isset($widgetContents['btn_link']) ? $widgetContents['btn_link'] : ''); ?>">
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH /mnt/c/Users/jstnh/airbnb-booking-site/resources/views/backend/pages/widgets/latest-destination.blade.php ENDPATH**/ ?>