...
<header class="header-area style-1">
    <div class="header-logo d-lg-none d-flex">
        <a href="<?php echo e(url('/')); ?>">
            <?php if(get_setting('header_logo')): ?>
                <img class="img-fluid" src="<?php echo e(asset('assets/logo/' . get_setting('header_logo'))); ?>" alt="Logo"
                    width="150">
            <?php else: ?>
                <img class="img-fluid" src="<?php echo e(asset('frontend/img/logo.svg')); ?>" alt="Logo" width="150">
            <?php endif; ?>
        </a>
    </div>
    <div class="company-logo d-lg-flex d-none">
        <a href="<?php echo e(url('/')); ?>">
            <?php if(get_setting('header_logo')): ?>
                <img src="<?php echo e(asset('assets/logo/' . get_setting('header_logo'))); ?>" alt="Logo" width="155">
            <?php else: ?>
                <img src="<?php echo e(asset('frontend/img/logo.svg')); ?>" alt="Logo" width="155">
            <?php endif; ?>
        </a>
    </div>
    <div class="main-menu">
        <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div class="mobile-logo-wrap">
                <a href="<?php echo e(url('/')); ?>">
                    <?php if(get_setting('header_logo')): ?>
                        <img src="<?php echo e(asset('assets/logo/' . get_setting('header_logo'))); ?>" alt="Logo">
                    <?php else: ?>
                        <img src="<?php echo e(asset('frontend/img/logo.svg')); ?>" alt="Logo">
                    <?php endif; ?>
                </a>
            </div>
        ...
        <?php if($menu_items->count() > 0): ?>
            <ul class="menu-list">
                <?php $__currentLoopData = $menu_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($menu_item->children->count() > 0): ?>
                        <li class="menu-item-has-children">
                            <a target="<?php echo e($menu_item->menu_type == 'custom' ? ($menu_item->new_tap == 1 ? '' : '') : ''); ?>"
                                href="<?php if($menu_item->menu_type == 'page'): ?> <?php echo e($menu_item->slug == 'home' ? url('/') : url($menu_item->slug)); ?><?php elseif($menu_item->menu_type == 'custom'): ?><?php echo e($menu_item->target); ?><?php else: ?><?php echo e(url('/blog/' . $menu_item->slug)); ?> <?php endif; ?>"
                                class="drop-down">
                                <?php if($menu_item->menu_type == 'page'): ?>
                                    <?php echo e($menu_item?->page?->getTranslation('page_name')); ?>

                                <?php elseif($menu_item->menu_type == 'category'): ?>
                                    <?php echo e($menu_item->category->getTranslation('name')); ?>

                                <?php elseif($menu_item->menu_type == 'blog'): ?>
                                    <?php echo e($menu_item?->blog?->getTranslation('title')); ?>

                                <?php else: ?>
                                    <?php echo e(Str::limit($menu_item->getTranslation('title'), 15)); ?>

                                <?php endif; ?>
                            </a><i class="bi bi-plus dropdown-icon"></i>
                            <ul class="sub-menu">
                                <?php $__currentLoopData = $menu_item->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($subMenu->children->count() > 0): ?>
                                        <li>
                                            <a class="<?php if($menu_item->menu_type == 'page'): ?> <?php echo e(($menu_item->slug == 'home' ? (request()->is('/') ? 'active' : '') : request()->is($menu_item->slug)) ? 'active' : ''); ?>

                                            <?php elseif($menu_item->menu_type == 'blog'): ?> <?php echo e(request()->segment(2) == $menu_item->slug ? 'active' : ''); ?> <?php else: ?> <?php echo e(request()->is($menu_item->slug) ? 'active' : ''); ?> <?php endif; ?>
                                          "
                                                target="<?php echo e($menu_item->menu_type == 'custom' ? ($menu_item->new_tap == 1 ? '' : '') : ''); ?>"
                                                href="<?php if($subMenu->menu_type == 'page'): ?> <?php echo e($subMenu->slug == 'home' ? url('/') : url($subMenu->slug)); ?><?php elseif($subMenu->menu_type == 'custom'): ?><?php echo e($subMenu->target); ?><?php else: ?><?php echo e(url('/blog/' . $subMenu->slug)); ?> <?php endif; ?>">
                                                <?php if($subMenu->menu_type == 'page'): ?>
                                                    <?php echo e($subMenu?->page?->getTranslation('page_name')); ?>

                                                <?php elseif($subMenu->menu_type == 'blog'): ?>
                                                    <?php echo e($subMenu?->blog?->getTranslation('title')); ?>

                                                <?php else: ?>
                                                    <?php echo e(Str::limit($subMenu->getTranslation('title'), 15)); ?>
                                            ...
                                            <ul class="sub-menu">
                                                <?php $__currentLoopData = $subMenu->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subSubMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><a class=" <?php if($menu_item->menu_type == 'page'): ?> <?php echo e(($menu_item->slug == 'home' ? (request()->is('/') ? 'active' : '') : request()->is($menu_item->slug)) ? 'active' : ''); ?>

                                                        <?php elseif($menu_item->menu_type == 'blog'): ?> <?php echo e(request()->segment(2) == $menu_item->slug ? 'active' : ''); ?> <?php else: ?> <?php echo e(request()->is($menu_item->slug) ? 'active' : ''); ?> <?php endif; ?>
                                                      "
                                                            target="<?php echo e($menu_item->menu_type == 'custom' ? ($menu_item->new_tap == 1 ? '' : '') : ''); ?>"
                                                            href="<?php if($subSubMenu->menu_type == 'page'): ?> <?php echo e($subSubMenu->slug == 'home' ? url('/') : url($subSubMenu->slug)); ?><?php elseif($subSubMenu->menu_type == 'custom'): ?><?php echo e($subSubMenu->target); ?><?php else: ?><?php echo e(url('/blog/' . $subSubMenu->slug)); ?> <?php endif; ?>">
                                                            <?php if($subSubMenu->menu_type == 'page'): ?>
                                                                <?php echo e($subSubMenu?->page?->getTranslation('page_name')); ?>

                                                            <?php elseif($subSubMenu->menu_type == 'blog'): ?>
                                                                <?php echo e($subSubMenu?->blog?->getTranslation('title')); ?>

                                                            <?php else: ?>
                                                                <?php echo e(Str::limit($subSubMenu->getTranslation('title'), 15)); ?>
                                    ...
                                    <?php else: ?>
                                        <li><a class=" <?php if($menu_item->menu_type == 'page'): ?> <?php echo e(($menu_item->slug == 'home' ? (request()->is('/') ? 'active' : '') : request()->is($menu_item->slug)) ? 'active' : ''); ?> <?php elseif($menu_item->menu_type == 'blog'): ?> <?php echo e(request()->segment(2) == $menu_item->slug ? 'active' : ''); ?> <?php else: ?> <?php echo e(request()->is($menu_item->slug) ? 'active' : ''); ?> <?php endif; ?>"
                                                href="
                                                <?php if($subMenu->menu_type == 'page'): ?> <?php echo e($subMenu->slug == 'home' ? url('/') : url($subMenu->slug)); ?>

                                                <?php elseif($subMenu->menu_type == 'custom'): ?>
                                                <?php echo e($subMenu->target); ?>

                                                <?php else: ?><?php echo e(url('/blog/' . $subMenu->slug)); ?> <?php endif; ?>"
                                                target="<?php echo e($menu_item->menu_type == 'custom' ? ($menu_item->new_tap == 1 ? '' : '') : ''); ?>">
                    ...
                    <?php else: ?>
                        <li>
                            <a class="<?php if($menu_item->menu_type == 'page'): ?> <?php echo e(($menu_item->slug == 'home' ? (request()->is('/') ? 'active' : '') : request()->is($menu_item->slug)) ? 'active' : ''); ?> <?php elseif($menu_item->menu_type == 'blog'): ?> <?php echo e(request()->segment(2) == $menu_item->slug ? 'active' : ''); ?> <?php else: ?> <?php echo e(request()->is($menu_item->slug) ? 'active' : ''); ?> <?php endif; ?>"
                                target="<?php echo e($menu_item->menu_type == 'custom' ? ($menu_item->new_tap == 1 ? '' : '') : ''); ?>"
                                href="<?php if($menu_item->menu_type == 'page'): ?> <?php echo e($menu_item->slug == 'home' ? url('/') : url($menu_item->slug)); ?><?php elseif($menu_item->menu_type == 'custom'): ?><?php echo e($menu_item->target); ?><?php else: ?><?php echo e(url('/blog/' . $menu_item->slug)); ?> <?php endif; ?>">
        ...
        <div class="topbar-right d-lg-none d-block">
            <button type="button" class="modal-btn header-cart-btn" data-bs-toggle="modal"
                ...
                <?php echo e(translate('REGISTER / LOGIN')); ?>

            </button>
        </div>
        <?php endif; ?>

        <?php if(get_setting('hotline_phone')): ?>
            <div class="hotline-area d-lg-none d-flex">
                ...
                <div class="content">
                    <span><?php echo e(get_setting('hotline_text') ?? translate('To More Inquiry')); ?></span>
                    <h6><a href="tel:<?php echo e(get_setting('hotline_phone')); ?>"><?php echo e(get_setting('hotline_phone')); ?></a></h6>
                </div>
            </div>
        <?php endif; ?>
    </div>
        ...
        <div class="nav-right d-flex justify-content-end align-items-center">
            <?php if(Auth::check()): ?>
                ...
                <div class="balance-area d-lg-flex d-none">
                    ...
                    <div class="content">
                        <span><?php echo e(translate('Total Balance')); ?></span>
                        <h6><?php echo e(format_currency(Auth::user()->wallet_balance)); ?> <sub>(<?php echo e(currency_code()); ?>)</sub></h6>
                    </div>
                </div>

                <div class="profile-area <?php if(Auth::check() && request()->is('customer/*')): ?> sidebar-toggle-button <?php endif; ?>">
                    <div class="profile-img">
                        <?php if(Auth::user()->image): ?>
                        <img src="<?php echo e(asset('uploads/users/'.Auth::user()->image)); ?>" alt="<?php echo e(Auth::user()->username); ?>">
                        <?php else: ?>
                        <img src="<?php echo e(asset('uploads/users/user.png')); ?>" alt="<?php echo e(Auth::user()->username); ?>">
                        <?php endif; ?>
                    </div>
                    <div class="profile-content">
                        <a <?php if(Auth::check() && request()->is('customer/*')): ?> href="#" <?php else: ?> href="<?php echo e(route('customer.dashboard')); ?>" <?php endif; ?>>
                        <span><?php echo e(translate('Hello')); ?>,</span>
                        <h6><?php echo e(Auth::user()->fname); ?></h6>
                        </a>
                    </div>
                </div>
                <?php else: ?>
                <div class="profile-area">
                    ...
                    <div class="profile-content">
                        <a href="<?php echo e(route('backend.dashboard')); ?>" target="new">
                        <span><?php echo e(translate('Hello')); ?>,</span>
                        <h6><?php echo e(Auth::user()->fname); ?></h6>
                        </a>
                    </div>
...
<!-- End header section -->
<?php /**PATH /home/wpgxubae/public_html/test.harmostays.com/resources/views/frontend/template-1/partials/header1.blade.php ENDPATH**/ ?>