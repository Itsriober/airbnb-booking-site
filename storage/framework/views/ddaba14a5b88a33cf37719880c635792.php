...
$featuresSubTitle = 'Demo Sub Title';
if (isset($singelWidgetData->widget_content)) {
    ...
    $featuresSubTitle = isset($featuresContent['features_sub_title']) ? $featuresContent['features_sub_title'] : '';
...
<div class="feature-card-section mb-100 mt-100">
        <img src="<?php echo e(asset('frontend/img/home1/section-vector4.png')); ?>" alt="" class="section-vector4">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center mb-60">
                        ...
                        <h2><?php echo e($featuresSubTitle); ?></h2>
                    </div>
                </div>
             </div>
             <div class="row g-md-4 gy-5">
                <?php $__currentLoopData = $featuresContent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xl-4 col-md-6">
                    <div class="feature-card <?php if($key % 3 === 2): ?> two <?php elseif($key % 3 === 0): ?> three <?php endif; ?>">
                        <?php if(isset($content['img'])): ?>
                        <div class="feature-card-icon">
                            <img src="<?php echo e(asset('uploads/features/'.$content['img'])); ?>" alt="image" width="65">
                        </div>
                        <?php endif; ?>
                        <div class="feature-card-content">
                            <h6><?php echo e(isset($content['name']) ? $content['name'] : ''); ?></h6>
                            <p><?php echo e(isset($content['descriptions']) ? $content['descriptions'] : ''); ?></p>
                        </div>
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH /home/wpgxubae/public_html/test.harmostays.com/resources/views/frontend/template-1/features.blade.php ENDPATH**/ ?>