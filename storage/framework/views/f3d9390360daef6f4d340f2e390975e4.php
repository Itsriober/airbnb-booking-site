            ...
            <div class="accordion-body">
                ...
                <form enctype="multipart/form-data" data-action="<?php echo e(route('pages.widget.save')); ?>" class="form"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
                                <label><?php echo e(translate('Number of Display')); ?></label>
                                <input type="number" class="username-input"
                                    placeholder="<?php echo e(translate('Number of Display')); ?>"
                                    name="content[0][limit]"
                                    value="<?php echo e(isset($widgetContents['limit']) ? $widgetContents['limit'] : ''); ?>">
                            </div>
                        </div>
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
...
<?php endif; ?>
<?php /**PATH /mnt/c/Users/jstnh/airbnb-booking-site/resources/views/backend/pages/widgets/featured-tour.blade.php ENDPATH**/ ?>