               ...
               ?>
                <form enctype="multipart/form-data" data-action="<?php echo e(route('pages.widget.save')); ?>" class="form"
                    ...
                    <div class="location-area">
                        ...
                        <?php if(isset($widgetContents['slider'])): ?>
                            <?php
                               $count = 0;
                            ?>
                            <?php $__currentLoopData = $widgetContents['slider']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $count++;
                                ?>
                                            ...
                                            <div class="col-sm-4 mb-3">
                                                <div class="form-inner">
                                                    ...
                                                    <input type="text" class="username-input"
                                                        ...
                                                        name="content[0][slider][<?php echo e($count); ?>][title]"
                                                        value="<?php echo e(isset($slider['title']) ? $slider['title'] : ''); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4 mb-3">
                                                <div class="form-inner">
                                                    ...
                                                    <input type="text" class="username-input"
                                                        ...
                                                        name="content[0][slider][<?php echo e($count); ?>][button_text]"
                                                        value="<?php echo e(isset($slider['button_text']) ? $slider['button_text'] : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-4 mb-2">
                                                <div class="form-inner">
                                                    ...
                                                    <input type="text" class="username-input"
                                                        ...
                                                        name="content[0][slider][<?php echo e($count); ?>][button_url]"
                                                        value="<?php echo e(isset($slider['button_url']) ? $slider['button_url'] : ''); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 mb-2">
                                                <div class="form-inner mb-3">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <input type="hidden"
                                                            name="content[0][slider][<?php echo e($count); ?>][img]"
                                                            id="old_file"
                                                            value="<?php echo e(isset($slider['img']) ? $slider['img'] : ''); ?>">
                                                            <small>*</small>

                                                        <?php if(isset($slider['img'])): ?>
                                                            <div class="ms-4">
                                                                <img width="100"
                                                                    src="<?php echo e(asset('uploads/sliders/' . $slider['img'])); ?>"
                                                                    alt="">
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
                                            ...
                                            <div class="col-sm-4 mb-2">
                                                <div class="form-inner">
                                                    ...
                                                    <input type="text" class="username-input"
                                                        ...
                                                        name="content[0][slider][<?php echo e($count); ?>][location]"
                                                        value="<?php echo e(isset($slider['location']) ? $slider['location'] : ''); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 mb-2">
                                                <div class="form-inner mb-3">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <input type="hidden"
                                                            name="content[0][slider][<?php echo e($count); ?>][rating_logo]"
                                                            id="old_file"
                                                            value="<?php echo e(isset($slider['rating_logo']) ? $slider['rating_logo'] : ''); ?>">
                                                            <small>*</small>

                                                        <?php if(isset($slider['rating_logo'])): ?>
                                                            <div class="ms-4">
                                                                <img width="100"
                                                                    src="<?php echo e(asset('uploads/sliders/' . $slider['rating_logo'])); ?>"
                                                                    alt="">
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
                                            ...
                                            <div class="col-sm-4 mb-2">
                                                <div class="form-inner">
                                                    ...
                                                    <input type="number" step="0.1" max="5" class="username-input"
                                                        ...
                                                        name="content[0][slider][<?php echo e($count); ?>][rating]"
                                                        value="<?php echo e(isset($slider['rating']) ? $slider['rating'] : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-12 mb-2">
                                                <div class="form-inner">
                                                    <label><?php echo e(translate('Description')); ?></label>
                                                    <textarea rows="6" name="content[0][slider][<?php echo e($count); ?>][description]"> <?php echo e(isset($slider['description']) ? $slider['description'] : ''); ?>  </textarea>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mb-2">
                                                <div class="form-inner">
                                                    ...
                                                    <input type="text" class="username-input"
                                                        placeholder="<?php echo e(translate('Location')); ?>"
                                                        name="content[0][slider][0][location]">
                                                </div>
                                            </div>
                                            <div class="col-sm-4 mb-2">
                                                <div class="form-inner">
                                                    ...
                                                    <input type="number" step="0.1" max="5" class="username-input"
                                                        placeholder="<?php echo e(translate('Rating (Out of 5)')); ?>"
                                                        name="content[0][slider][0][rating]">
                                                </div>
                                            </div>
...
<?php endif; ?>
<?php /**PATH /mnt/c/Users/jstnh/airbnb-booking-site/resources/views/backend/pages/widgets/sliders.blade.php ENDPATH**/ ?>