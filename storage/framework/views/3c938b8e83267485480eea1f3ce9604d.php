<?php
    $tabs = '';
    $title = 'Explore Your Activities';
    $shoulder = 'Are you ready to travel?';

    if (!empty($singelWidgetData->widget_content)) {
        $widgetContent = $singelWidgetData->getTranslation('widget_content');
        $shoulder = isset($widgetContent['shoulder']) ? $widgetContent['shoulder'] : '';
        $title = isset($widgetContent['title']) ? $widgetContent['title'] : '';
        $tabs = isset($widgetContent['tabs']) ? $widgetContent['tabs'] : '';
    }
?>
                    ...
                    <div class="row g-xl-4 gy-5 ">
                        <div class="col-xl-5">
                            <div class="verticle-tab-sidebar">
                                <ul class="nav nav-pills" id="pills-tab5" role="tablist">
                                    <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="nav-item" role="presentation">
                                        <div class="nav-link <?php echo e($loop->first ? 'active' : ''); ?>" id="nature-tab<?php echo e($key); ?>" data-bs-toggle="pill"
                                            data-bs-target="#nature<?php echo e($key); ?>" role="tab" aria-controls="nature<?php echo e($key); ?>"
                                            aria-selected="true">
                                            <?php if(isset($menu['tab_img'])): ?>
                                            <div class="icon">
                                                <img src="<?php echo e(asset('uploads/tabs/'.$menu['tab_img'])); ?>" width="70">
                                            </div>
                                            <?php endif; ?>
                                            <h6><?php echo e(isset($menu['tab_title']) ? $menu['tab_title'] : ''); ?></h6>
                                        </div>
                                    </li>
                        ...
                        <div class="col-xl-7 d-flex justify-content-xl-start justify-content-center">
                            <div class="tab-content" id="pills-tab5Content">
                                ...
                                <div class="tab-pane fade <?php echo e($loop->first ? 'show active' : ''); ?>" id="nature<?php echo e($key); ?>" role="tabpanel"
                                    aria-labelledby="nature-tab">
                                    <div class="verticle-tab-content-wrap">
                                        <div class="verticle-tab-content">
                                            <div class="eg-tag2">
                                                <span><?php echo e(isset($tab['label']) ? $tab['label'] : ''); ?></span>
                                            </div>
                                            <h2><?php echo e(isset($tab['main_title']) ? $tab['main_title'] : ''); ?></h2>
                                            <p><?php echo e(isset($tab['description']) ? $tab['description'] : ''); ?></p>

                                            <?php if(isset($tab['include']) && $tab['include'] && is_array($tab['include'])): ?>
                                                <ul>
                                                    <?php $__currentLoopData = $tab['include']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                            ...
                                            <div class="content-bottom-area">
                                                <?php if(isset($tab['button_link']) && isset($tab['button_text']) ): ?>
                                                <a href="<?php echo e(isset($tab['button_link']) ? $tab['button_link'] : ''); ?>"
                                                    class="primary-btn1"><?php echo e(isset($tab['button_text']) ? $tab['button_text'] : ''); ?></a>
                                                    <?php endif; ?>
                                                    <?php if(isset($tab['video_text']) && isset($tab['video_link'])): ?>
                                                <a data-fancybox="popup-video" href="<?php echo e(isset($tab['video_link']) ? $tab['video_link'] : '#'); ?>"
                                                    class="video-area">
                                                    <div class="icon">
                                                        <svg class="video-circle" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            width="51px" viewBox="0 0 206 206"
                                                            style="enable-background:new 0 0 206 206;"
                                                            xml:space="preserve">
                                                            <circle class="circle" stroke-miterlimit="10" cx="103"
                                                                cy="103" r="100"></circle>
                                                    ...
                                                    <h6><?php echo e(isset($tab['video_text']) ? $tab['video_text'] : ''); ?></h6>
                                                </a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="verticle-tab-img">
                                            <div class="verticle-tab-img1 mb-25 text-end">
                                                <?php if(isset($tab['img']) && !empty($tab['img'])): ?>
                                                    <img src="<?php echo e(asset('uploads/tabs/' . $tab['img'])); ?>" width="170"
                                                        alt="image 1">
                                                <?php endif; ?>
                                            </div>
                                            <div class="verticle-tab-img2 text-end">
                                                <?php if(isset($tab['img2']) && !empty($tab['img2'])): ?>
                                                    <img src="<?php echo e(asset('uploads/tabs/' . $tab['img2'])); ?>" width="170"
                                                        alt="image 2">
                                                <?php endif; ?>
                                            </div>
                                        </div>
...
<?php endif; ?>
<?php /**PATH /home/wpgxubae/public_html/test.harmostays.com/resources/views/frontend/template-1/tab-activities.blade.php ENDPATH**/ ?>