...
class CustomerController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $image = $request->file('image');
        if ($image != '') {
            if ($customers->image && file_exists(public_path('uploads/users/' . $customers->image))) {
    ...
    public function changeStatus()
    {
        ...
        if ($status && $customerId) {
            ...
            if ($customers->update()) {
                $response = array('output' => 'success', 'statusId' => $customers->status, 'dataId' => $customers->id, 'message' => $message, 'active' => translate('Active'), 'deactive' => translate('Deactive'));
