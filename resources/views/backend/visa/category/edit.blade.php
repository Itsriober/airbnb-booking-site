        ...
        <div class="page-title d-flex justify-content-between align-items-center">
            ...
            <div class="language-changer">
                ...
                @foreach (\App\Models\Language::all() as $key => $language)
                    ...
                    @else
                        <a href="{{ route('visa.category.edit', ['id' => $categorySingle->id, 'lang' => $language->code]) }}"><img
                                src="{{ asset('assets/img/flags/' . $language->code . '.png') }}" class="mr-3"
                                height="16"></a>
                    @endif
                @endforeach
            </div>
            <a href="{{ route('visa.category.list') }}" class="eg-btn btn--primary back-btn"> <img
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="eg-card product-card">
                ...
                <form action="{{ route('visa.category.update', $categorySingle->id) }}" method="POST"
