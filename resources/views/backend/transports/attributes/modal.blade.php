     ...
     <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
             ...
             <div class="modal-header">
                 <h5 class="modal-title" id="staticBackdropLabel">{{ translate('Add Transport Attribute') }}</h5>
                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
             </div>

             <form action="{{ route('transports.attribute.store') }}" method="POST">
                 @csrf
                 ...
                 <div class="modal-footer border-start">
