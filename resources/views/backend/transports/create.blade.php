                ...
                <div class="eg-card product-card">
                    ...
                    <div class="form-inner mb-35">
                        ...
                        <input type="text" class="username-input" value="{{ old('title') }}" name="title"
                            placeholder="{{ translate('Name of the Transport') }}">
                        @error('title')
                    ...
                    <div class="form-inner mb-35">
                        ...
                        <input type="text" class="username-input" value="{{ old('youtube_video') }}"
                            name="youtube_video" placeholder="{{ translate('Youtube Video Link') }}">
                        @error('youtube_video')
                            <div class="error text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-inner mb-35">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="username-input" value="{{ old('faq_title') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-inner mb-35">
                                ...
                                <input type="number" class="username-input" value="{{ old('min_stay') }}" name="min_stay"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-inner mb-35 pt-3">
                                            ...
                                            <input type="text" class="username-input" value="{{ old('car_type') }}"
                                                name="car_type" placeholder="{{ translate('Enter Car Type') }}">
                                            @error('car_type')
                                                <div class="error text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-inner mb-35 pt-3">
                                            ...
                                            <input type="number" class="username-input"
                                                value="{{ old('car_person') }}" name="car_person"
                                                placeholder="{{ translate('Enter Person') }}">
                                            @error('car_person')
                                                <div class="error text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-inner mb-35">
                                            ...
                                            <input type="number" class="username-input"
                                                value="{{ old('car_price') }}" name="car_price"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-inner mb-35">
                                            ...
                                            <input type="number" class="username-input"
                                                value="{{ old('car_sale_price') }}" name="car_sale_price"
                                                placeholder="{{ translate('Enter Sale Price') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-inner mb-35 pt-3">
                                            ...
                                            <input type="number" class="username-input"
                                                value="{{ old('bus_price') }}" name="bus_price"
                                                placeholder="{{ translate('Enter Adult Price') }}">
                                            @error('bus_price')
                                                <div class="error text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-inner mb-35 pt-3">
                                            ...
                                            <input type="number" class="username-input"
                                                value="{{ old('bus_sale_price') }}" name="bus_sale_price"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-inner mb-35 pt-3">
                                            ...
                                            <input type="number" class="username-input"
                                                value="{{ old('bus_child_price') }}" name="bus_child_price"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-inner mb-35 pt-3">
                                            <label>{{ translate('Adult Price') }} <span class="text-danger">*</span></label>
                                            <input type="number" class="username-input"
                                                value="{{ old('train_price') }}" name="train_price"
                                                placeholder="{{ translate('Enter Adult Price') }}">
                                            @error('train_price')
                                                <div class="error text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-inner mb-35 pt-3">
                                            <label>{{ translate('Adult Sale Price') }}</label>
                                            <input type="number" class="username-input"
                                                value="{{ old('train_sale_price') }}" name="train_sale_price"
                                                placeholder="{{ translate('Enter Adult Sale Price') }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-inner mb-35 pt-3">
                                            <label>{{ translate('Child Price') }}</label>
                                            <input type="number" class="username-input"
                                                value="{{ old('train_child_price') }}" name="train_child_price"
                                                placeholder="{{ translate('Enter Child Price') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-inner mb-35 pt-3">
                                            <label>{{ translate('Adult Price') }} <span class="text-danger">*</span></label>
                                            <input type="number" class="username-input"
                                                value="{{ old('boat_price') }}" name="boat_price"
                                                placeholder="{{ translate('Enter Adult Price') }}">
                                            @error('boat_price')
                                                <div class="error text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-inner mb-35 pt-3">
                                            <label>{{ translate('Adult Sale Price') }}</label>
                                            <input type="number" class="username-input"
                                                value="{{ old('boat_sale_price') }}" name="boat_sale_price"
                                                placeholder="{{ translate('Enter Adult Sale Price') }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-inner mb-35 pt-3">
                                            <label>{{ translate('Child Price') }}</label>
                                            <input type="number" class="username-input"
                                                value="{{ old('boat_child_price') }}" name="boat_child_price"
                                                placeholder="{{ translate('Enter Child Price') }}">
