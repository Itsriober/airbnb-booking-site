...
@section('content')
        ...
        <div class="col-12">
            <div class="table-wrapper">
                <table class="eg-table table customer-table">
                    ...
                    <tbody>
                        @if ($transportReviews->count() > 0)
                            @foreach ($transportReviews as $key => $productReview)
                                <tr>
                                    <td data-label="S.N">
                                        {{ ($transportReviews->currentpage() - 1) * $transportReviews->perpage() + $key + 1 }}
                                    </td>
                                    ...
                                    <td data-label="Status">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input flexSwitchCheckStatus" type="checkbox"
                                                ...
                                                data-id="{{ $productReview->id }}" data-type="transportsReview"
    ...
    @include('backend.transports.modal')
    @push('footer')
        <div class="d-flex justify-content-center custom-pagination">
            {!! $transportReviews->links() !!}
        </div>
    @endpush
@endsection
