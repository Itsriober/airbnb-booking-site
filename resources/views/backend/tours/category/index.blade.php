            ...
            <div class="table-wrapper">
                <table class="eg-table table category-table">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="Status">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input flexSwitchCheckStatus" type="checkbox"
                                                ...
                                                data-id="{{ $category->id }}" data-type="tourcategory"
                                ...
                                <td data-label="Language">
                                    @foreach (\App\Models\Language::all() as $key => $language)
                                        ...
                                        @else
                                            <a
                                                href="{{ route('tour.category.edit', ['id' => $category->id, 'lang' => $language->code]) }}"><i
                                ...
                                <td data-label="Option">
                                    <div
                                        ...
                                        <a class="eg-btn add--btn"
                                            href="{{ route('tour.category.edit', ['id' => $category->id, 'lang' => get_setting('DEFAULT_LANGUAGE', 'en')]) }}"><i
                                                class="bi bi-pencil-square"></i></a>
                                        <form method="POST" action="{{ route('tour.category.delete', $category->id) }}">
                                            @csrf
                        ...
                        @else
                        <tr>
                            <td colspan="7" class="text-center">{{translate('Yoo! Nothings Here Bruhv')}}</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
