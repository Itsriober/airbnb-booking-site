                ...
                <table class="eg-table table customer-table">
                    ...
                    <tbody>
                        @if ($tourReviews->count() > 0)
                            @foreach ($tourReviews as $key => $productReview)
                         
                                <tr>
                                    <td data-label="S.N">
                                        {{ ($tourReviews->currentpage() - 1) * $tourReviews->perpage() + $key + 1 }}
                                    </td>
                                    ...
                                    <td data-label="Email / Phone"> <a
                                        ...
                                        <br><a href="tel:{{ $productReview->users->phone }}"
                                            class="phone">{{ $productReview->users->phone }}</a>
                                    </td>
                                    <td data-label="Rate">
                                    ...
                                    <td data-label="Status">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input flexSwitchCheckStatus" type="checkbox"
                                                ...
                                                data-id="{{ $productReview->id }}" data-type="toursReview"
