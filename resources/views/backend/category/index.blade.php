...
.select2-container {
    ...
    <div class="row mb-35">
        <div class="page-title d-flex justify-content-between align-items-center">
            ...
            <button type="button" class="eg-btn btn--primary back-btn me-1" data-bs-toggle="modal"
                ...
                {{ translate('Add New Category') }}</button>
            <button type="button" class="eg-btn btn--primary back-btn" data-bs-toggle="modal"
                data-bs-target="#subcategoryBackdrop"><img src="{{ asset('backend/images/icons/add-icon.svg') }}" alt="Add New Sub Category">
                {{ translate('Add New Sub Category') }}</button></div>
        </div>
    </div>
    @php
                    ...
                    <tbody>
                        @foreach ($categories as $key => $category)
                            <tr>
                                ...
                                <td data-label="Category Name">{{ $category->parent ? $category->parent->getTranslation('name') : null }}</td>
    ...
    @include('backend.category.subcategory_modal')
