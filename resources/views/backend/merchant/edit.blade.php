              ...
              @section('content')
                ...
                <div class="eg-card product-card">
                    ...
                    <form action="{{route('merchant.update',$merchantSingle->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <h4 class="form-box-title">{{translate('Agency Info')}}</h4>
                        <div class="form-box mb-35">
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="form-inner">
                                        <label>{{translate('Agency Name')}} <span class="text-danger">*</span></label>
                                        <input type="text" name="shop_name" value="{{old('shop_name',$merchantSingle->shop?->name)}}" class="username-input" placeholder="{{translate('Enter Agency Name')}}" readonly>
                                        @error('shop_name')
                                        <div class="error text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-inner">
                                        <label>{{translate('Agency Email')}}</label>
                                        <input type="text" name="shop_email" value="{{old('shop_email',$merchantSingle->shop?->email)}}" class="username-input" placeholder="{{translate('Enter Agency Email')}}">
                                        @error('shop_email')
                                        <div class="error text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-inner">
                                        <label>{{translate('Agency Phone')}}</label>
                                        <input type="text" name="shop_phone" value="{{old('shop_phone',$merchantSingle->shop?->phone)}}" class="username-input" placeholder="{{translate('Enter Agency Phone')}}">
                                        @error('shop_phone')
                                        <div class="error text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-inner">
                                        <label>{{translate('Agency Address')}}</label>
                                        <input type="text" name="shop_address" value="{{old('shop_address',$merchantSingle->shop?->address)}}" class="username-input" placeholder="{{translate('Enter Agency Address')}}">
                                        @error('shop_address')
                                        <div class="error text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-inner">
                                        <label>{{translate('Agency Logo')}}</label>
