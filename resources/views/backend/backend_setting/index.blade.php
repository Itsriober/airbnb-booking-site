...
@section('content')
    <div class="page-title2">
        ...
        <a class="clear-cache" title="Remove all old data or demo data to default state." onclick="return confirm('Are you sure remove old all data to default state?')" href="{{ route('deleteDemoData') }}"><i class="bi bi-eraser"></i> Clear All Data</a>
    </div>
                            ...
                            <div class="col-xl-6">
                                <div class="form-inner mb-35">
                                    ...
                                    @if (get_setting('admin_logo'))
                                        <img class="mt-2" src="{{ asset('assets/logo/' . get_setting('admin_logo')) }}"
