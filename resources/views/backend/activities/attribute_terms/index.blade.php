...
.select2-container {
                            ...
                            <tr>
                                ...
                                <td data-label="Language">
                                    @foreach (\App\Models\Language::all() as $key => $language)
                                        ...
                                        @else
                                            <a
                                                href="{{ route('activities.attribute.terms.edit', ['attribute_id' => $attribute_id,'id' => $term->id, 'lang' => $language->code]) }}"><i
                                ...
                                <td data-label="Option">
                                    <div
                                        ...
                                        <a class="eg-btn add--btn"
                                            href="{{ route('activities.attribute.terms.edit', ['attribute_id' => $attribute_id,'id' => $term->id, 'lang' => get_setting('DEFAULT_LANGUAGE', 'en')]) }}"><i
                                                class="bi bi-pencil-square"></i></a>
                                        <form method="POST" action="{{ route('activities.attribute.terms.delete', ['attribute_id' => $attribute_id,'id' => $term->id]) }}">
                                            @csrf
    ...
    @include('backend.activities.attribute_terms.modal')
@endsection
