 ...
 <div class="modal fade" id="staticBackdropReview" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
     ...
     <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
             ...
             <form action="{{ route('hotels.review.reply') }}" method="POST">
                 @csrf
                 <input type="hidden" name="product_type" id="product_type" value="hotel">
                 <input type="hidden" name="product_id" id="product_id">
                 <input type="hidden" name="review_id" id="review_id">
                 <input type="hidden" name="product_type" value="hotel">
                 <div class="modal-body">
                     <div class="form-inner mb-35">
                         <textarea type="text" name="reply_message" rows="5" id="reply_message" class="username-input"
                             placeholder="{{ translate('Reply Message') }}" required></textarea>
                     </div>
                 </div>
                 <div class="modal-footer border-white">
                     ...
                     <button type="submit"
                         class="eg-btn btn--primary py-1 px-3 rounded">{{ translate('Submit') }}</button>
                 </div>
             </form>
         </div>
     </div>
