     ...
     <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
             ...
             <div class="modal-header">
                 <h5 class="modal-title" id="staticBackdropLabel">{{ translate('Add Hotel Attribute') }}</h5>
                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
             </div>

             <form action="{{ route('hotel.attribute.store') }}" method="POST">
                 @csrf
                 <div class="modal-body">
                     <div class="form-inner mb-35">
                         ...
                         <input type="text" name="name" id="attribute_name" value="{{ old('name') }}"
                             class="username-input" placeholder="{{ translate('Enter Hotel Attribute Name') }}"
                             required>
                         @error('name')
