            ...
            <div class="sidebar-header">
                <a href="{{ route('backend.dashboard') }}" class="header-logo-icon">
                    @if (get_setting('front_favicon'))
                        <img src="{{ asset('assets/logo/' . get_setting('front_favicon')) }}" alt="header-logo-icon">
                    @else
                        <img src="{{ asset('backend/images/bg/title-loog.svg') }}" alt="header-logo-icon">
                    @endif
                </a>
                ...
                <img src="{{ asset('backend/images/icons/sidebar.svg') }}" class="sidebar-toggle-button"
                ...
                <div class="admin-area dropdown">
                    ...
                    <div id="lang-change">
                        <a class="no-arrow dropdown-toggle d-flex jusify-content-start align-items-center gap-2 border-none"
                            ...
                            aria-expanded="false">
                            <span class="">
                                <img src="{{ asset('assets/img/flags/' . $locale . '.png') }}"
                                    alt="{{ translate('Language') }}" height="11">
                ...
                <div class="admin-area dropdown">
                    <button class=" dropdown-toggle d-flex jusify-content-start align-items-center gap-2 border-none"
                        ...
                        <span class="admin-thumb">
                            @if (Auth::user()->image)
                                <img src="{{ asset('uploads/users/' . Auth::user()->image) }}" alt="Profile Photo">
                            @else
                                <img src="{{ asset('uploads/users/user.png') }}" alt="Profile Photo">
                            @endif
                        </span>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                        <li><a class="dropdown-item " href="{{ route('backend.profile') }}"><i
                                    class="bi bi-person"></i>{{ translate('Profile') }}</a></li>
                        <li><a class="dropdown-item" href="{{ route('backend.shop') }}"><i
                                    class="bi bi-gear"></i>{{ translate('My Agency') }}</a></li>
                        @admin
                            <li><a class="dropdown-item" href="{{ route('frontend.setting') }}"><i
                                        class="bi bi-gear"></i>{{ translate('Frontend Settings') }}</a></li>
                            <li><a class="dropdown-item" href="{{ route('backend.setting') }}"><i
                                        class="bi bi-gear"></i>{{ translate('Backend Settings') }}</a></li>
                        @endadmin
                        <li><a class="dropdown-item" href="{{ route('logout') }}"
                                onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i
                                    class="bi bi-box-arrow-left"></i>{{ translate('Logout') }}</a></li>
