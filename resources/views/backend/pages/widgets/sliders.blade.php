                                ...
                                <div class="row align-items-center content">
                                    <div class="col-sm-11">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 mb-2">
                                                <div class="form-inner">
                                                    ...
                                                    <input type="text" class="username-input"
                                                        ...
                                                        name="content[0][slider][{{ $count }}][location]"
                                                        value="{{ isset($slider['location']) ? $slider['location'] : '' }}">
                                                </div>
                                            </div>
                                            
                                            <div class="col-sm-6 mb-2">
                                                <div class="form-inner mb-3">
                                                    <label>{{ translate('Rating Logo') }}</label>
                                                    <div class="d-flex">
                                                        <input type="file" class="username-input widget-image-upload"
                                                            name="image" data-folder="/uploads/sliders/">

                                                        <input type="hidden"
                                                            name="content[0][slider][{{ $count }}][rating_logo]"
                                                            id="old_file"
                                                            value="{{ isset($slider['rating_logo']) ? $slider['rating_logo'] : '' }}">
                                                            <small>*</small>

                                                        @if (isset($slider['rating_logo']))
                                                            <div class="ms-4">
                                                                <img width="100"
                                                                    src="{{ asset('uploads/sliders/' . $slider['rating_logo']) }}"
                                                                    alt="">
                                                            </div>
                                                        @endif
                                                    </div>
                                            ...
                                            <div class="col-sm-4 mb-2">
                                                <div class="form-inner">
                                                    <label>{{ translate('Rating (Out of 5)') }}</label>
                                                    <input type="number" step="0.1" max="5" class="username-input"
                                                        placeholder="{{ translate('Rating (Out of 5)') }}"
                                                        name="content[0][slider][{{ $count }}][rating]"
                                                        value="{{ isset($slider['rating']) ? $slider['rating'] : '' }}">
                                                </div>
                                            </div>
