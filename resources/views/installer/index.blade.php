...
<div class="installment-section">
    <div class="installment-wrap">
        <input type="hidden" id="final" value="{{ request()->is('install/final') || request()->is('install/import-demo') ? 'final' : '' }}" />
        <ul class="installment-form-step" id="progressbar">
            <li class=" {{ request()->is('install/final')   ||  request()->is('install/import-demo')  ? 'active' : '' }}">
                <div class="icon">
            ...
            <li class=" {{ request()->is('install/final') ? 'active' : '' }}">
                <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
                        <g>
                            <path
        ...
        <div id="msform" class="installment-form">
            ...
            <fieldset class="server-requirement">
                <form action="{{ route('install.requirement') }}">
                    ...
                    <div class="requirement_html">
                        ...
                        @if (isset($phpSupportInfo, $requirements))
            ...
            <fieldset class="permission">
                <form action="{{ route('install.permission') }}">
                    ...
                    <div class="permission-html">
                        @if (isset($permissions))
                            @include('installer.permission', ['permissions' => $permissions])
                        @endif
                    </div>
                    <div class="step-btn-group">
                        <button class="prev previous-btn">
            ...
            <fieldset class="demo-content {{ request()->is('install/import-demo') ? 'active' : '' }}">
                <form action="{{ route('install.demo') }}">
                    ...
                    <div class="step-title mb-25">
                        ...
                        <div class="form-input-area">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" checked name="demo_import" id="flexCheckChecked" >
            ...
            <fieldset class="Finished {{ request()->is('install/final') ? 'active' : '' }} justify-centent-center">


                <div class="loader-installer {{ request()->is('install/final') ? 'installer-hide' : '' }}">
                    <div class="bar1"></div>
                </div>
                ...
                @if (request()->is('install/final'))
                    ...
                    <div class="congulation">
                        <p>Your <b>{{ env('APP_NAME') }}</b> setup is complete, and you're now ready to experience the
                            seamless
                    ...
                    <div class="access-user">
                        ...
                        <div>
                            ...
                            <p><b>Email:</b> merchant@gmail.com</p>
                            <p><b>Password:</b> 123456789</p>
                        </div>
                    ...
                    <div class="step-btn-group">
                        <div class="step-btn-group">
                            <a target="__blank" href="{{ url('/') }}"  class="next-btn">Frontend Url
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24">
                                    <g>
                                        <path
                        ...
                        <div class="step-btn-group">
                            <a target="__blank" href="{{ url('/admin/login') }}" class="next-btn">Backend Url
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24">
                                    <g>
                                        <path
