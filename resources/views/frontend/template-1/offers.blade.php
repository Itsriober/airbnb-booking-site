...
<div class="banner2-section mb-100 mt-100">
        <div class="container">
            <div class="row">
             ...
             @if(count($offers) <= 3)
             @foreach ($offers as $key => $itemData)
                <div class="@if(count($offers) == 3) col-lg-4 @elseif(count($offers) == 2) col-lg-6 @elseif(count($offers) == 1) col-lg-12 @endif">
                    <div class="banner2-card">
                        <img src="{{asset('uploads/offers/'.$itemData['img'])}}" alt="{{$itemData['offer_title']}}" width="100%">
                        <div class="banner2-content-wrap">
                            <div class="banner2-content">
                                <span>{{$itemData['offer_title']}}</span>
                                <h3>{{$itemData['offer_discount']}}</h3>
                                <a href="{{$itemData['offer_link']}}">{{$itemData['offer_button']}}</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @else
                <div class="col-lg-3">
                    <div class="banner2-card">
                    <img src="{{asset('uploads/offers/'.$offers[1]['img'])}}" alt="{{$offers[1]['offer_title']}}" width="100%">
                        <div class="banner2-content-wrap">
                            <div class="banner2-content">
                            <span>{{$offers[1]['offer_title']}}</span>
                                <h3>{{$offers[1]['offer_discount']}}</h3>
                                <a href="{{$offers[1]['offer_link']}}">{{$offers[1]['offer_button']}}</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <img src="{{asset('uploads/offers/'.$offers[2]['img'])}}" alt="{{$offers[2]['offer_title']}}" width="100%">
                                <div class="banner2-content-wrap">
                                    <div class="banner2-content">
                                    <span>{{$offers[2]['offer_title']}}</span>
                                    <a href="{{$offers[2]['offer_link']}}">{{$offers[2]['offer_button']}}</a>
                                    </div>
                                    <div class="offer-batch">
                                    <span>{{$offers[2]['offer_discount']}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            ...
                            <img src="{{asset('uploads/offers/'.$offers[3]['img'])}}" alt="{{$offers[3]['offer_title']}}" width="100%">
                                <div class="banner2-content-wrap d-flex align-items-center">
                                    <div class="w-100">
                                        <div class="banner2-content">
                                        <span>{{$offers[3]['offer_title']}}</span>
                                <h5>{{$offers[3]['offer_discount']}}</h5>
                                <p>{{translate('For Your First Book')}}</p>
                                        </div>
                                        <a href="{{$offers[3]['offer_link']}}" class="primary-btn1">{{$offers[3]['offer_button']}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <img src="{{asset('uploads/offers/'.$offers[4]['img'])}}" alt="{{$offers[4]['offer_title']}}" width="100%">
                        <div class="banner2-content-wrap">
                            <div class="banner2-content">
                            <span>{{$offers[4]['offer_title']}}</span>
                            <h3>{{$offers[4]['offer_discount']}}</h3>
                            <p>{{translate('For Your First Book')}}</p>
                            </div>
                            <a href="{{$offers[4]['offer_link']}}" class="primary-btn1">{{$offers[4]['offer_button']}}</a>
                        </div>
                    </div>
                </div>
            @endif
