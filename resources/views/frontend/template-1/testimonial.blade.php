        ...
        <div class="container">
            <div class="testimonial-nav-area">
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    @if(isset($testimonials['tripadvisor']))
                    <li class="nav-item" role="presentation">
                      <div class="nav-link {{isset($testimonials['tripadvisor']) ? 'active' : ''}}" id="tripadvisor-tab" data-bs-toggle="pill" data-bs-target="#tripadvisor" role="tab" aria-controls="tripadvisor" aria-selected="true">
                        <div class="icon">
                            <img src="{{asset('frontend/img/home1/icon/tripadvisor-logo3.svg')}}" alt="">
                        </div>
                        {{translate('Tripadvisor')}}
                    </div>
                    </li>
                    @endif
                    @if(isset($testimonials['facebook']))
                    <li class="nav-item" role="presentation">
                      <div class="nav-link {{!isset($testimonials['tripadvisor']) && isset($testimonials['facebook']) ? 'active' : ''}}" id="facebook-tab" data-bs-toggle="pill" data-bs-target="#facebook" role="tab" aria-controls="facebook" aria-selected="false">
                        <div class="icon">
                            <img src="{{asset('frontend/img/home1/icon/facebook-logo.svg')}}" alt="">
                        </div>
                        {{translate('Facebook')}}
                      </div>
                    </li>
                    @endif
                    @if(isset($testimonials['google']))
                    <li class="nav-item" role="presentation">
                      <div class="nav-link {{!isset($testimonials['tripadvisor']) && !isset($testimonials['facebook']) && isset($testimonials['google']) ? 'active' : ''}}" id="google-tab" data-bs-toggle="pill" data-bs-target="#google" role="tab" aria-controls="google" aria-selected="false">
                        <div class="icon">
                            <img src="{{asset('frontend/img/home1/icon/google-logo.svg')}}" alt="">
                        </div>
                        {{translate('Google')}}
                    </div>
                    </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tab-content" id="pills-tabContent">
                            @if(isset($testimonials['tripadvisor']))
                            <div class="tab-pane fade {{isset($testimonials['tripadvisor']) ? 'show active' : ''}}" id="tripadvisor" role="tabpanel" aria-labelledby="tripadvisor-tab">
                                <div class="swiper testimonial-card-slider">
                                    <div class="swiper-wrapper">
                                        @foreach($testimonials['tripadvisor'] as $item)
                                            ...
                                            <div class="tesimonial-card-wrapper">
                                                <div class="tesimonial-card">
                                                    ...
                                                    <div class="testimonial-bottom">
                                                        <div class="rating-area tripadvisor">
                                                            ...
                                                            <img class="d-block" src="{{asset('frontend/img/home1/icon/tripadvisor-text-logo.svg')}}" alt="">
                                                        </div>
                                                        <div class="quote">
                                                        ...
                                                        <div class="date-and-time">
                                                            <p>{{date('M d, Y', strtotime($item['time']))}}</p>
                                                ...
                                                <div class="author-area">
                                                    ...
                                                    <div class="author-img">
                                                        <img src="{{('uploads/testimonials/'.$item['img'])}}" alt="{{$item['name']}}">
                                                    </div>
                                                    @endif
                            ...
                            @endif
                            @if(isset($testimonials['facebook']))
                            <div class="tab-pane fade {{!isset($testimonials['tripadvisor']) && isset($testimonials['facebook']) ? 'show active' : ''}}" id="facebook" role="tabpanel" aria-labelledby="facebook-tab">
                                <div class="swiper testimonial-card-slider">
                                    <div class="swiper-wrapper">
                                        @foreach($testimonials['facebook'] as $item)
                                        <div class="swiper-slide">
                                            <div class="tesimonial-card-wrapper">
                                                <div class="tesimonial-card">
                                                    <div class="testimonial-content">
                                                    ...
                                                    <div class="testimonial-bottom">
                                                        <div class="rating-area">
                                                            ...
                                                            <img src="{{asset('frontend/img/home1/icon/facebook-text-logo.svg')}}" alt="">
                                                        </div>
                                                        <div class="quote">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="74" height="51" viewBox="0 0 74 51">
                                                                <g>
                            ...
                            @endif
                            @if(isset($testimonials['google']))
                            <div class="tab-pane fade {{!isset($testimonials['tripadvisor']) && !isset($testimonials['facebook']) && isset($testimonials['google']) ? 'show active' : ''}}" id="google" role="tabpanel" aria-labelledby="google-tab">
                                <div class="swiper testimonial-card-slider">
                                    <div class="swiper-wrapper">
                                        @foreach($testimonials['google'] as $item)
                                        <div class="swiper-slide">
                                            <div class="tesimonial-card-wrapper">
                                                <div class="tesimonial-card">
                                                    <div class="testimonial-content">
                                                    ...
                                                    <div class="testimonial-bottom">
                                                        <div class="rating-area">
                                                            ...
                                                            <img src="{{asset('frontend/img/home1/icon/google-text-logo.svg')}}" alt="">
                                                        </div>
                                                        <div class="quote">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="74" height="51" viewBox="0 0 74 51">
                                                                <g>
