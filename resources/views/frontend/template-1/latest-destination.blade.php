...
<div class="home1-destination-section mb-120">
    <img src="{{asset('frontend/img/home1/section-vector2.png')}}" alt="destinations" class="section-vector2">
    <div class="container">
         <div class="row">
            <div class="col-lg-12">
         ...
         <div class="row g-4">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="destination-card">
                   <img src="{{asset('uploads/destination/features/'.$destination->features_image)}}" alt="{{$destination->title}}">
                   <div class="overlay"></div>
                   <div class="card-title">
                        <h4>{{$destination->getTranslation('destination')}}</h4>
                   </div>
                   <div class="content">
                        <h4><a href="{{route('destination.details',$destination->slug)}}">{{$destination->getTranslation('destination')}}</a></h4>
                        <div class="eg-tag">
                            <span>
                                {{$destination->tours?->count()}} {{translate('Tour')}}
                            </span>
                        </div>
                   </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="destination-banner">
                    <div class="destination-banner-content">
                        ...
                        <a href="{{$btn_link}}" class="primary-btn1">{{$btn_text}}</a>
                        @endif
                    </div>
                </div>
            </div>
