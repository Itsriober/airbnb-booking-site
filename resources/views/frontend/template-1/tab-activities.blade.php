                    ...
                    <div class="row g-xl-4 gy-5 ">
                            ...
                            <div class="verticle-tab-sidebar">
                                <ul class="nav nav-pills" id="pills-tab5" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <div class="nav-link {{$loop->first ? 'active' : ''}}" id="nature-tab{{$key}}" data-bs-toggle="pill"
                                            data-bs-target="#nature{{$key}}" role="tab" aria-controls="nature{{$key}}"
                                            aria-selected="true">
                                            @if(isset($menu['tab_img']))
                                            <div class="icon">
                                                <img src="{{asset('uploads/tabs/'.$menu['tab_img'])}}" width="70">
                                            </div>
                                            @endif
                                            <h6>{{ isset($menu['tab_title']) ? $menu['tab_title'] : '' }}</h6>
                                        </div>
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="col-xl-7 d-flex justify-content-xl-start justify-content-center">
                            <div class="tab-content" id="pills-tab5Content">
                                ...
                                <div class="tab-pane fade {{$loop->first ? 'show active' : ''}}" id="nature{{$key}}" role="tabpanel"
                                    aria-labelledby="nature-tab">
                                    <div class="verticle-tab-content-wrap">
                                        <div class="verticle-tab-content">
                                            <div class="eg-tag2">
                                                <span>{{ isset($tab['label']) ? $tab['label'] : '' }}</span>
                                            </div>
                                            <h2>{{ isset($tab['main_title']) ? $tab['main_title'] : '' }}</h2>
                                            <p>{{ isset($tab['description']) ? $tab['description'] : '' }}</p>

                                            @if (isset($tab['include']) && $tab['include'] && is_array($tab['include']))
                                                <ul>
                                                    @foreach ($tab['include'] as $items)
                                                    <li>
                                            ...
                                            <div class="content-bottom-area">
                                                @if(isset($tab['button_link']) && isset($tab['button_text']) )
                                                <a href="{{ isset($tab['button_link']) ? $tab['button_link'] : '' }}"
                                                    class="primary-btn1">{{ isset($tab['button_text']) ? $tab['button_text'] : '' }}</a>
                                                    @endif
                                                    @if(isset($tab['video_text']) && isset($tab['video_link']))
                                                <a data-fancybox="popup-video" href="{{ isset($tab['video_link']) ? $tab['video_link'] : '#' }}"
                                                    class="video-area">
                                                    <div class="icon">
                                                    ...
                                                    <h6>{{ isset($tab['video_text']) ? $tab['video_text'] : '' }}</h6>
                                                </a>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="verticle-tab-img">
                                            <div class="verticle-tab-img1 mb-25 text-end">
                                                @if (isset($tab['img']) && !empty($tab['img']))
                                                    <img src="{{ asset('uploads/tabs/' . $tab['img']) }}" width="170"
                                                        alt="image 1">
                                                @endif
                                            </div>
                                            <div class="verticle-tab-img2 text-end">
                                                @if (isset($tab['img2']) && !empty($tab['img2']))
                                                    <img src="{{ asset('uploads/tabs/' . $tab['img2']) }}" width="170"
                                                        alt="image 2">
                                                @endif
                                            </div>
                                        </div>
