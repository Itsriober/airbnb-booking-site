...
<div class="feature-card-section mb-100 mt-100">
        <img src="{{asset('frontend/img/home1/section-vector4.png')}}" alt="" class="section-vector4">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center mb-60">
                        ...
                        <h2>{{$featuresSubTitle}}</h2>
                    </div>
                </div>
             </div>
             <div class="row g-md-4 gy-5">
                @foreach($featuresContent as $key => $content)
                <div class="col-xl-4 col-md-6">
                    <div class="feature-card @if($key % 3 === 2) two @elseif ($key % 3 === 0) three @endif">
                        @if(isset($content['img']))
                        <div class="feature-card-icon">
                            <img src="{{asset('uploads/features/'.$content['img'])}}" alt="image" width="65">
                        </div>
                        @endif
                        <div class="feature-card-content">
                            <h6>{{isset($content['name']) ? $content['name'] : ''}}</h6>
                            <p>{{isset($content['descriptions']) ? $content['descriptions'] : ''}}</p>
                        </div>
                    </div>
                </div>
                @endforeach
