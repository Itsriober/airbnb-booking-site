                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="home1-banner-wrapper"
                            style="background-image: linear-gradient(180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100%), url({{ asset('uploads/sliders/' . $itemData['img']) }});">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="home1-banner-content">
                                            ...
                                            <div class="banner-content-bottom">
                                                ...
                                                <a href="{{$itemData['button_url']}}" class="primary-btn1">{{$itemData['button_text']}} </a>
                                                @endif
                                                @if($itemData['rating'])
                                                <div class="rating-area">
                                                    @if($itemData['rating_logo'])
                                                    <div class="icon">
                                                        <img width="50" src="{{ asset('uploads/sliders/' . $itemData['rating_logo']) }}" alt="icon">
                                                    </div>
                                                    @endif
                                                    <div class="content">
                                                        <div class="rating">
                                                            <ul>
                                                            @php $rating = $itemData['rating']; @endphp
                                                            ...
                                                            <span>{{$itemData['rating'] ? $itemData['rating'].'/5.0' : ''}}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endif
